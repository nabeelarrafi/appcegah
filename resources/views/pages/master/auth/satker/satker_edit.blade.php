...
@section('nav')
    ...
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Master:Work:Unit:Index') }}">Satuan Kerja</a></li>
            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('Admin:Dashboard:Master:Work:Unit:Update', ['unit' => $data['edit']->id_satker]) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Deskripsi..." name="description" type="text" value="{{ $data['edit']->description }}">
                            </div>
                            <div class="form-group">
                                <label class="main-content-label tx-11 tx-medium tx-gray-900">Singkatan</label>
                                <input class="form-control" placeholder="Singkatan..." name="abbreviation" required type="text" value="{{ $data['edit']->abbreviation }}">
                            </div>
                            <div class="form-footer">
                                <button class="btn btn-primary float-right">Update</button>
                                <a href="{{ route('Admin:Dashboard:Master:Work:Unit:Index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
