            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Input role baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:Role:Store') }}" method="post">
                            @csrf
                ...
                <div class="card">
                    <div class="card-header pb-0 pd-t-25">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Daftar Role</h4>
                        </div>
                        <p class="tx-12 text-muted mb-0">Role</p>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('Admin:Dashboard:Master:Role:Edit', ['role' => $role->id_role]) }}" class="btn btn-info btn-icon" style="display: inline-block"><i class="typcn typcn-edit"></i></a>
                                            <form data-form-id="{{ $role->id_role }}" action="{{ route('Admin:Dashboard:Master:Role:Destroy', ['role' => $role->id_role]) }}" method="POST"  style="display: inline-block">
                                                @csrf
                                                @method('delete')
                                                <button data-btn-id="{{ $role->id_role }}" onclick="confirmDelete(this)" class="btn btn-danger btn-icon" type="button"><i class="typcn typcn-trash"></i></button>
                                            </form>
                                            @endif
                                        </td>
                                    </tr>
