            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Input user baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:User:Store') }}" method="post">
                            @csrf
                                ...
                                <select class="form-control" required name="id_role">
                                    ...
                                    @foreach ($data['role'] as $role)
                                        @if($role->name !== 'Super Admin')
                                            <option value="{{ $role->id_role }}" @if(old('id_role') == $role->id_role) selected @endif>
                                                {{ $role->name }}
                                            </option>
                                        @endif
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Username..." name="username" required type="text" value="{{ old('username') }}">
                            </div>
                            <div class="form-group">
                                <label class="main-content-label tx-11 tx-medium tx-gray-900">Password</label>
                                <input class="form-control" placeholder="Password..." name="password" required type="password">
                            </div>
                            <div class="form-group">
                                <label class="main-content-label tx-11 tx-medium tx-gray-900">Confirm Password</label>
