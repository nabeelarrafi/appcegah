            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Input sub menu baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:Sub:Menu:Store') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="id_menu">
                                    ...
                                    @foreach ($data['menus'] as $menu)
                                        <option value="{{ $menu->id_menu }}" @if(old('id_menu') == $menu->id_menu) selected @endif>
                                            {{ $menu->name }}
                                        </option>
                                    @endforeach
                                </select>
