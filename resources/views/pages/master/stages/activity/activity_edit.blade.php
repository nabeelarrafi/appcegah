...
@section('nav')
    ...
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Master:Activity:Index') }}">Kegiatan</a></li>
            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Edit kegiatan</p>
                        <form action="{{ route('Admin:Dashboard:Master:Activity:Update', ['activity' => $data['edit']->id_kegiatan]) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_grup_kegiatan" class="form-control">
                                    ...
                                    @foreach ($data['group_act'] as $group_act)
                                        <option value="{{ $group_act->id_grup_kegiatan }}" @if($data['edit']->id_grup_kegiatan == $group_act->id_grup_kegiatan) selected @endif>
                                            {{ $group_act->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-footer">
                                ...
                                <a href="{{ route('Admin:Dashboard:Master:Activity:Index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
