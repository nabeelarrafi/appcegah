...
@section('nav')
    ...
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Master:Fiscal:Year:Index') }}">Tahun Anggaran</a></li>
            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Edit tahun anggran</p>
                        <form action="{{ route('Admin:Dashboard:Master:Fiscal:Year:Update', ['year' => $data['edit']->id_tahun_anggaran]) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-footer">
                                ...
                                <a href="{{ route('Admin:Dashboard:Master:Fiscal:Year:Index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
