@extends('app.header')
@section('title', 'Grup Aktivitas')
@section('nav')
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Index') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Master:Group:Activity:Index') }}">Grup Aktivitas</a></li>
            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Edit grup aktivitas</p>
                        <form action="{{ route('Admin:Dashboard:Master:Group:Activity:Update', ['activity' => $data['edit']->id_grup_kegiatan]) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_instrument" class="form-control select2">
                                    ...
                                    @foreach ($data['instrument'] as $instrument)
                                        <option value="{{ $instrument->id_instrumen }}" @if($instrument->id_instrumen === $data['edit']->id_instrumen) selected @endif>{{ $instrument->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-footer">
                                ...
                                <a href="{{ route('Admin:Dashboard:Master:Group:Activity:Index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
