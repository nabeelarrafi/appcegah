...
@section('nav')
    ...
    <li class="breadcrumb-item active" aria-current="page">Aktivitas Pengendalian</li>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="main-content-label mg-b-5">
                            Aktiviats Pengendalian Baru
                        </div>
                        <p class="mg-b-20 text-muted">Input aktivitas pengendalian baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:Control:Activity:Store') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_kegiatan" class="form-control select2">
                                    ...
                                    @foreach ($data['activity'] as $activity)
                                        <option value="{{ $activity->id_kegiatan }}" @if(old('id_kegiatan') == $activity->id_kegiatan) selected @endif>
                                            {{ $activity->name }}
                                        </option>
                                    @endforeach
                                </select>
