...
@section('nav')
    ...
    <li class="breadcrumb-item"><a href="{{ route('Admin:Dashboard:Master:Country:Index') }}">Negara</a></li>
            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Edit negara</p>
                        <form action="{{ route('Admin:Dashboard:Master:Country:Update', ['country' => $data['edit']->id_negara]) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-footer">
                                ...
                                <a href="{{ route('Admin:Dashboard:Master:Country:Index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header pb-0 pd-t-25">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">List of Country</h4>
                        </div>
                        <p class="tx-12 text-muted mb-0">Country</p>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table text-md-nowrap table-striped" id="example2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Admin:Dashboard:Master:Country:Edit', ['country' => $country->id_negara]) }}" class="btn btn-info btn-icon" style="display: inline-block"><i class="typcn typcn-edit"></i></a>
                                            <form data-form-id="{{ $country->id_negara }}" action="{{ route('Admin:Dashboard:Master:Country:Destroy', ['country' => $country->id_negara]) }}" method="POST"  style="display: inline-block">
                                                @csrf
                                                @method('delete')
                                                <button data-btn-id="{{ $country->id_negara }}" onclick="confirmDelete(this)" class="btn btn-danger btn-icon" type="button"><i class="typcn typcn-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
    ...
    @section('script')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                toggleMenu('.fa-map-marker-alt', 'area/country');
            })
        </script>
