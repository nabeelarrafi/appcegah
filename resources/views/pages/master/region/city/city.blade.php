            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Input kabupaten / kota baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:City:Store') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="id_province">
                                    ...
                                    @foreach ($data['province'] as $province)
                                        <option value="{{ $province->id_provinsi }}" @if(old('id_province') == $province->id_provinsi) selected @endif>
                                            {{ $province->name }}
                                        </option>
                                    @endforeach
                                </select>
