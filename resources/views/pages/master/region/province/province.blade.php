            ...
            <div class="col-md-5 col-xl-5 col-xs-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20 text-muted">Input provinsi baru</p>
                        <form action="{{ route('Admin:Dashboard:Master:Province:Store') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="id_country">
                                    ...
                                    @foreach ($data['country'] as $country)
                                        <option value="{{ $country->id_negara }}" @if(old('id_country') == $country->id_negara) selected @endif>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
