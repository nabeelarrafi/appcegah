                                        ...
                                        <table class="table text-md-nowrap table-striped" id="example2">
                                            ...
                                            <tbody>
                                                @foreach ($data['rkas'] as $rkas)
                                                    <tr>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $loop->iteration }}</a></td>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $rkas->provinsi }}</a></td>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $rkas->persen }}%</a></td>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $rkas->total_sekolah }}</a></td>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $rkas->total_kirim }}</a></td>
                                                        <td><a href="{{ route('Admin:Dashboard:Rkas:Province:Detail', ['kode_wilayah' => $rkas->kode_prop]) }}">{{ $rkas->total_sisa }}</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
    ...
    <script>
        $(function() {
            ...
            @if($data['region'] === 'Provinsi' && $data['is_detail'])
                toggleMenu('.fa-share', 'rkas/provinsi');
            @elseif($data['region'] === 'KabupatenKota' && $data['is_detail'])
                toggleMenu('.fa-share', 'rkas/kabupatenkota');
            @endif

            @if($data['region'] === 'Provinsi')
                $('.search').click(function() {
                    let id  = $('select[name="provinsi"]').val();
                    let url = `{{ route('Admin:Dashboard:Rkas:Province') }}/${id}`;
            ...
            @if($data['region'] === 'KabupatenKota')
                ...
                $('.search').click(function() {
                    ...
                    let url = `{{ route('Admin:Dashboard:Rkas:City') }}/${id}`;
