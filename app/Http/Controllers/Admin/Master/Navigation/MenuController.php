...
class MenuController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['menus']       = \DB::table('m_menu')->select('id_menu', 'name', 'url', 'is_active')->where('is_active', 1)->orderBy('name', 'asc')->get();
        $data['menu_cat']   = \DB::table('m_menu_category')->select('id_menu_category', 'name')->where('is_active', 1)->orderBy('name', 'asc')->get();

        return view('pages.master.navigation.menu.menu', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        $validator = \Validator::make($request->all(), [
            ...
            'fa_class' => ['required'],
            'url' => ['required'],
            'id_menu_category' => ['required'],
        ]);

        if($validator->fails()) return redirect()->route('Admin:Dashboard:Master:Menu:Index')->with('error', 'All data must be filled!')->withInput();
        ...
        return redirect()->route('Admin:Dashboard:Master:Menu:Index')->with('success', 'Data successfully added!')->withInput(['id_menu_category' => $request->id_menu_category]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.master.navigation.menu.menu_edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails()) return redirect()->route('Admin:Dashboard:Master:Menu:Edit', ['menu' => $id])->with('error', 'All data must be filled!');
        ...
        return redirect()->route('Admin:Dashboard:Master:Menu:Index')->with('success', 'Data successfully updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('Admin:Dashboard:Master:Menu:Index')->with('success', 'Data successfully deleted!');
    }
}
