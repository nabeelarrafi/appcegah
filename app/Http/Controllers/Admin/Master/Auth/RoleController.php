...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['role']       = \DB::table('m_role')->select('id_role', 'name', 'description')->where('is_active', 1)->get();

        return view('pages.master.auth.role.role', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()) return redirect()->route('Admin:Dashboard:Master:Role:Index')->with('error', 'All input must be filled!')->withInput();
        ...
        return redirect()->route('Admin:Dashboard:Master:Role:Edit', ['role' => $id_role])->with('success', 'Data successfully added!');
    }
    ...
    public function edit($id)
    {
        ...
        $data['menus']      = \DB::table('m_menu')->select('id_menu', 'name')->where('is_active', 1)->orderBy('name')->get();
        $data['edit']       = Role::find($id);

        return view('pages.master.auth.role.role_edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails()) return redirect()->route('Admin:Dashboard:Master:Role:Edit', ['role' => $id])->with('error', 'All input must be filled!');
        ...
        return redirect()->route('Admin:Dashboard:Master:Role:Index')->with('success', 'Data successfully updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('Admin:Dashboard:Master:Role:Index')->with('success', 'Data successfully deleted!');
    }
}
